                            ...
                            @foreach(config('app.languages') as $lang)
                                <div class="tab-pane fade {{$loop->first ? 'active show' : ''}}" id="tab-{{$lang}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Description One" name="{{$lang}}[description_one]"
                                               value="{{old($lang.'description_one', isset($model) ? $model->translateOrDefault($lang)->description_one : '' )}}"
                                               class="form-control">
                                        @error("$lang.description_one")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label>Description Two</label>
                                        <input type="text" placeholder="Description Two" name="{{$lang}}[description_two]"
                                               value="{{old($lang.'description_two', isset($model) ? $model->translateOrDefault($lang)->description_two : '' )}}"
                                               class="form-control">
                                        @error("$lang.description_two")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                </div>
